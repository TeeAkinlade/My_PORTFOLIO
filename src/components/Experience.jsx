...
const Experience = () => {
  ...
  return (
    <div
      name="experience"
      className='bg-gradient-to-b from-gray-800 to to-black w-full h-full py-14 px-3 md:px-0 md:py-20'
    >
      <div className='max-w-screen-lg mx-auto p-4 flex flex-col justify-center w-full h-full text-white'>
        ...
        <div className="w-full grid grid-cols-2 sm:grid-cols-3 gap-8 text-center py-8 px-1 md:px-12 sm:px-0">{techs.map(({ id, src, title, style }) => (
          <div 
            key={id}

...
const About = () => {
  return (
    <motion.div
        ...
        >
        <div name="about" 
            className="w-full h-min bg-[#22254b] md:h-max pt-6 px-3 lg:px-28 md:px-16 md:py-20 text-white">
            <div className="p-4 mx-auto flex flex-col justify-center w-full h-full">
                <div className="pb-8">
                    <p className='text-4xl font-bold inline border-b-4 border-black'>About</p>
                    <p className=" text-lg md:text-xl mt-20 px-6 md:px-12 leading-7 lg:px-16 font-light">

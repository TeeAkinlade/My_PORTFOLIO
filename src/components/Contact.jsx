...
const Contact = () => {
  return (
    <div
      name="contact"
      className="w-full h-full text-secondary pt-10 md:py-20 bg-primary lg:px-28 md:px-16"
    >
      <div className="flex flex-col p-6 mx-auto h-full pb-8">
        <div className="pb-8">
          <p className="text-4xl px-2 font-bold inline border-b-4 border-secondary">
            Contact
          </p>
         ...
         <div className="w-full flex md:flex-row flex-col flex-wrap justify-center gap-10 lg:gap-[2rem] pt-8 md:pt-16 px-8">
            <div className="flex flex-col w-full md:w-[40%] lg:w-[30%] rounded-[2rem] p-8 shadow-lg border border-secondary">

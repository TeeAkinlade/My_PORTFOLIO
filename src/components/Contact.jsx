...
const Contact = () => {
  return (
    <div
      name="contact"
      className="w-full h-full bg-gradient-to-b from-black to-gray-800 text-white md:py-20 p-4"
    >
      <div className="flex flex-col justify-center max-w-screen-lg px-4 mx-auto h-full mb-8">
        <div className="pb-8">
